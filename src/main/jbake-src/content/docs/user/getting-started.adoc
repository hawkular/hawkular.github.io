...
Download
http://download.jboss.org/hawkular/hawkular/${hawkular.released.version}/hawkular-dist-${hawkular.released.version}.zip[Hawkular ${hawkular.released.version} (zip)]
...
[source,shell]
----
unzip hawkular-dist-${hawkular.released.version}.zip #<1>
cd hawkular=${hawkular.released.version}
...
* Unzip the file inside the `modules` directory of your Hawkular distribution
