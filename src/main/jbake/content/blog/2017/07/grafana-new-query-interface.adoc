...
The other important feature is the ability to run link:http://www.hawkular.org/hawkular-metrics/docs/user-guide/#_downsampling[_stats_] queries against Hawkular Metrics, instead of link:http://www.hawkular.org/hawkular-metrics/docs/user-guide/#_raw_data[_raw_] queries.
