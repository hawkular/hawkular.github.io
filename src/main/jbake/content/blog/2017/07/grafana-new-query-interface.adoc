...
The other important feature is the ability to run link:http://www.hawkular.org/docs/rest/rest-metrics.html#NumericBucketPoint[_stats_] queries against Hawkular Metrics, instead of link:http://www.hawkular.org/docs/rest/rest-metrics.html#DataPoint[_raw_] queries.
