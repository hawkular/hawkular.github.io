...
When the alert engine detects a problem, it sends an action message to the configured sender(s) for this type issue. The
action message has all the details:
