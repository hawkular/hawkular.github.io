...
:jbake-tags: blog, APM, Zipkin, polyglot, microservices, distributed tracing
...
image::https://raw.githubusercontent.com/hawkular/hawkular-apm/master/examples/polyglot-zipkin/architecture.png[title="Architecture of polyglot application",align="center"]
...
ifdef::env-github[]
image::../../../../../assets/img/blog/2016/apm-distributed-tracing-createUser.png[title="Hawkular APM Distributed 
Tracing",
align="center"]
endif::[]
