...
ifndef::env-github[]
image::/img/metrics_scalability.png[width=]
endif::[]
...
Timestamps are link:https://en.wikipedia.org/wiki/Unix_time[unix timestamps] in milliseconds. The value of a data point
will vary depending on the metric type.
