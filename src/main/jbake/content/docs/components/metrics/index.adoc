...
though (See https://issues.jboss.org/browse/HWKMETRICS-208[HWKMETRICS-208] for details). For this reason it is
...
https://issues.jboss.org/browse/HWKMETRICS-384(HWKMETRICS-384) for details.
...
The parts that comprise the metric id provide name spacing. A metric name only has to be unique for the metric type and
