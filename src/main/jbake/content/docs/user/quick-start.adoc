...
TIP: If you plan on monitoring multiple servers, pass in the command line option "--managed-server-name=YourUniqueName" where "YourUniqueName" is some *unique* value among your managed machines.
