...
NOTE: Hawkular is built on top of Wildfly and ships an embedded Cassandra and Keycloak, intended for a quick start.
For real deployments, make sure to read the documentation about those components for the required bootstrap
tasks, such as setting admin users, appropriate JVM flags, ...
