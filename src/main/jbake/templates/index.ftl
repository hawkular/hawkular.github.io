...
<#include "navigation.ftl">
    ...
    <div class="homepage">
      ...
      <section class="description">
        <p>
          Hawkular provides a flexible and easy to use Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip you need.
        </p>
      </section>
          ...
          <div class="row">
            <ul>
              <li class="col-md-3 col-sm-4">
                ...
                <p>Ready to run dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
              </li>
              <li class="col-md-3 col-sm-4">
              ...
              <li class="col-md-3 col-sm-4">
                ...
                <p>View and manage your data in the management console, including real time updates.</p>
              </li>
              <li class="col-md-3 col-sm-4">
              ...
              <li class="col-md-3 col-sm-4">
                ...
                <p>Add Push Notifications to your applications with the Aerogear Unified Push Server (UPS).</p>
              </li>
              <li class="col-md-3 col-sm-4">
                ...
                <p>This hilarious feature is a silver bullet to all third world problems.</p>
              </li>
              <li class="col-md-3 col-sm-4">
