...
==============================================
*Endpoint* `/triggers/groups/tags`


NOTE: *Create a new group trigger tag* +
      _Returns Tag created if operation finished correctly_

*Method*
****
*POST* `/triggers/groups/tags`
****
...
==============================================
*Endpoint* `/triggers/groups/{groupId}/tags`
...
*Method*
****
*PUT* `/triggers/groups/{groupId}/tags`
****
...
|=======================
|Parameter|Required|Description|Data Type
    |groupId|true|Trigger id of tags to be deleted|string
|=======================
*query parameters*
