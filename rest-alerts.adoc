...
|=======================
|Parameter|Required|Description|Data Type
    |alertIds|true|comma separated list of alertIds to tag|string
    |tags|true|comma separated list of tags to add, each tag of format &#39;name|value&#39;.|string
|=======================
...
|=======================
|Parameter|Required|Description|Data Type
    |alertIds|true|comma separated list of alertIds to untag|string
    |tagNames|true|comma separated list of tag names to remove|string
|=======================
...
|=======================
|Parameter|Required|Description|Data Type
    |eventIds|true|comma separated list of eventIds to tag|string
    |tags|true|comma separated list of tags to add, each tag of format &#39;name|value&#39;.|string
|=======================
...
|=======================
|Parameter|Required|Description|Data Type
    |eventIds|true|comma separated list of eventIds to untag|string
    |tagNames|true|comma separated list of tag names to remove|string
|=======================
...
NOTE: *Create a new full trigger (trigger, dampenings and conditions)* +
      _Returns created full Trigger_
...
|=======================
|Parameter|Required|Description|Data Type
    |body|true|Full Trigger definition (trigger, dampenings, conditions) to be created|string
|=======================
...
==============================================
*Endpoint* `/triggers/trigger/{triggerId}`
...
*Method*
****
*GET* `/triggers/trigger/{triggerId}`
****
...
|=======================
|Parameter|Required|Description|Data Type
    |triggerId|true|Full Trigger definition id to be retrieved|string
|=======================
...
|=======================
| Name | Type | Required | Description | Allowable Values
|conditionSetSize|int|optional|-|-
|type|Type|optional|-|AVAILABILITY, COMPARE, STRING, THRESHOLD, RANGE, EXTERNAL, EVENT, RATE
|conditionId|string|optional|-|-
|triggerMode|Mode|optional|-|FIRING, AUTORESOLVE
|triggerId|string|optional|-|-
|tenantId|string|optional|-|-
|conditionSetIndex|int|optional|-|-
|dataId|string|optional|-|-
|context|Map[string,string]|optional|-|-
|=======================
...
|=======================
| Name | Type | Required | Description | Allowable Values
|dampenings|Array[Dampening]|optional|-|-
|trigger|Trigger|optional|-|-
...
|memberTags|Map[string,string]|optional|-|-
...
|type|TriggerType|optional|-|STANDARD, GROUP, DATA_DRIVEN_GROUP, MEMBER, ORPHAN
