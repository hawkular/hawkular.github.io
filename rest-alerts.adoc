...
|type|Yes|The type of the condition defined. Each type has its specific properties defined on its subtype of condition.|string|AVAILABILITY, COMPARE, STRING, THRESHOLD, RANGE, EXTERNAL, EVENT, RATE, MISSING|-
...
|type|No|The type of the condition eval defined. Each type has its specific properties defined on its subtype of condition eval.|string|AVAILABILITY, COMPARE, STRING, THRESHOLD, RANGE, EXTERNAL, EVENT, RATE, MISSING|-
