...
NOTE: *Create a new condition for a specific trigger. Add/Delete/Update of a condition effectively replaces the condition set for the trigger.  The new condition set is returned. Clients code should then use the new condition set as ConditionIds may have changed!* 
...
NOTE: *Update an existing condition for a specific trigger. Add/Delete/Update of a condition effectively replaces the condition set for the trigger.  The new condition set is returned. Clients code should then use the new condition set as ConditionIds may have changed!* 
...
NOTE: *Delete an existing condition for a specific trigger. Add/Delete/Update of a condition effectively replaces the condition set for the trigger.  The new condition set is returned. Clients code should then use the new condition set as ConditionIds may have changed!* 
