...
=== String
. link:#++GET__strings++[Find tenant's metric definitions.]
. link:#++POST__strings++[Create string metric.]
. link:#++POST__strings_raw++[Add metric data for multiple string metrics in a single call.]
. link:#++GET__strings_tags__tags_++[Retrieve string type's tag values]
. link:#++GET__strings__id_++[Retrieve single metric definition.]
. link:#++GET__strings__id__raw++[Retrieve string data.]
. link:#++POST__strings__id__raw++[Add data for a single string metric.]
. link:#++GET__strings__id__tags++[Retrieve tags associated with the metric definition.]
. link:#++PUT__strings__id__tags++[Update tags associated with the metric definition.]
. link:#++DELETE__strings__id__tags__tags_++[Delete tags associated with the metric definition.]
...
|201|Metric created successfully|-
|400|Missing or invalid payload|<<ApiError>>
|409|String metric with given id already exists|<<ApiError>>
|500|Metric creation failed due to an unexpected error|<<ApiError>>
...
[[GET__strings_tags__tags_]]
*Endpoint GET `/strings/tags/{tags}`*

NOTE: *Retrieve string type's tag values* +
...
[[DELETE__strings__id__tags__tags_]]
