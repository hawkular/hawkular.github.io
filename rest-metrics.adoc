...
| 500    | Metric creation failed due to an unexpected error | [ApiError](#<<ApiError>>)
...
| 201    | Metric created successfully | -
| 400    | Missing or invalid payload | [ApiError](#<<ApiError>>)
| 409    | Metric with given id already exists | [ApiError](#<<ApiError>>)
| 500    | Metric creation failed due to an unexpected error | [ApiError](#<<ApiError>>)
...
|=======================
|Parameter|Required|Description|Data Type
    |type|false|Queried metric type|<<UNKNOWN[T],UNKNOWN[T]>>
...
|=======================
|Parameter|Required|Description|Data Type
    |body|true||<<TenantDefinition,TenantDefinition>>
|=======================
...
|=======================
| Name | Type | Required | Description | Allowable Values
|data|Array[AvailabilityDataPoint]|optional|Availability data points|-
|id|string|required|Identifier of the metric|-
|=======================
...
|=======================
| Name | Type | Required | Description | Allowable Values
|value|AvailabilityType|required|-|AvailabilityType{code=0, text=up}, AvailabilityType{code=1, text=down}, AvailabilityType{code=2, text=unknown}
...
|=======================
| Name | Type | Required | Description | Allowable Values
|data|Array[CounterDataPoint]|optional|Counter data points|-
|id|string|required|Identifier of the metric|-
|=======================
...
|=======================
| Name | Type | Required | Description | Allowable Values
|data|Array[GaugeDataPoint]|optional|Gauge data points|-
|id|string|required|Identifier of the metric|-
|=======================
...
|=======================
| Name | Type | Required | Description | Allowable Values
|type|org.hawkular.metrics.core.api.MetricType&lt;T&gt;|optional|Metric type|-
|tenantId|string|optional|Identifier of the tenant|-
|dataRetention|int|optional|How long, in days, a data point of this metric stays in the system after it is stored|-
|tags|Map[string,string]|optional|Metric tags|-
|id|string|required|Identifier of the metric|-
|=======================
...
|=======================
| Name | Type | Required | Description | Allowable Values
|retentions|Map[org.hawkular.metrics.core.api.MetricType&lt;?&gt;,int]|optional|Retention settings for metrics, expressed in days|-
|id|string|required|Identifier of the tenant|-
|=======================
