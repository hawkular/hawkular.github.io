...
|=======================
|Parameter|Required|Description|Data Type
    |type|true|Queried metric type|<<org.hawkular.metrics.core.api.MetricType,org.hawkular.metrics.core.api.MetricType>>
|=======================
...
| 400    | Missing or invalid type parameter type. | [ApiError](#<<ApiError>>)
