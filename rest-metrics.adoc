...
|200|Successfully fetched data.|object
|204|No matching data found.|-
|400|Missing or invalid tags query|<<ApiError>>
|500|Any error in the query.|<<ApiError>>
...
|200|Availability values fetched successfully|object
|204|No matching data found.|-
|400|Invalid tags|<<ApiError>>
|500|Any error while fetching data.|<<ApiError>>
...
[[POST__availability__id__tag]]
*Endpoint POST `/availability/{id}/tag`*
...
|200|Metric values fetched successfully|object
|204|No matching data found.|-
|400|Invalid tags|<<ApiError>>
|500|Any error while fetching data.|<<ApiError>>
...
[[POST__gauges__id__tag]]
*Endpoint POST `/gauges/{id}/tag`*
...
|200|Tags were modified successfully.|-
|400|Missing or invalid payload|<<ApiError>>
|500|Processing tags failed|<<ApiError>>
