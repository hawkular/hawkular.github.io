...
### /analytics/businesstxn/bounduris/{name}
...
### /analytics/businesstxn/completion/count
...
|Parameter|Located in|Required|Description|Default|Schema
 ...
 |name|query|yes|business transaction name
 | - |
...
### /analytics/businesstxn/completion/faultcount
...
### /analytics/businesstxn/completion/faults
...
|Parameter|Located in|Required|Description|Default|Schema
 ...
 |body|body|yes|business transaction criteria
 | - |
...
### /analytics/businesstxn/completion/percentiles
...
### /analytics/businesstxn/completion/property/{property}
...
### /analytics/businesstxn/completion/statistics
...
Get the business transaction completion statistics associated with criteria
...
### /analytics/businesstxn/properties/{name}
...
### /analytics/businesstxn/unbounduris
...
|Parameter|Located in|Required|Description|Default|Schema
 ...
 |name|query|no|business transaction name
 | - |
