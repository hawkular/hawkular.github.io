...
Get the business transaction count
...
### /analytics/businesstxn/faultcount
...
Get the business transaction stats associated with criteria
...
|=======================
| Status Code | Reason      | Response Model
| 200    | Success | <<BusinessTransactionStats,BusinessTransactionStats>>
| 500    | Internal server error |  - 
...
Retrieve the business transaction names
