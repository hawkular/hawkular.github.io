...
|=======================
|Parameter|Required|Description|Data Type
    |body|false|This is either a metric blueprint or a list of paths to metrics to be associated with the resource. They can either be canonical or relative to the resource.|<<Object,Object>>
|=======================
...
| 404    | Tenant, environment, resource doesn&#39;t exist. Also when an array of strings is supplied and one of the metrics in that array doesn&#39;t exist. | [ApiError](#<<ApiError>>)
| 500    | Server error | [ApiError](#<<ApiError>>)
...
=== Work with the events emitted by inventory
...
|=======================
|Parameter|Required|Description|Data Type
    |body|false||<<AsyncResponse,AsyncResponse>>
|=======================
