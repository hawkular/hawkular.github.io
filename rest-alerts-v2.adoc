...
| PUT | /tags | link:#++PUT__tags++[Add tags to existing Alerts.]
...
| GET | /actions | link:#++GET__actions++[Find all action ids grouped by plugin.]
...
| GET | /actions/{actionPlugin}/{actionId} | link:#++GET__actions__actionPlugin___actionId_++[Get an existing action definition.]
...
|200|Successfully fetched map of action ids grouped by plugin.|Map of <<Collection>>
|500|Internal server error.|<<ApiError>>
...
|200|Success, ActionDefinition found.|<<ActionDefinition>>
|404|No ActionDefinition found.|<<ApiError>>
|500|Internal server error.|<<ApiError>>
...
|===
| GET | /events | link:#++GET__events++[Get events with optional filtering.]
...
| PUT | /events/tags | link:#++PUT__events_tags++[Add tags to existing Events.]
...
|200|Success, Events tagged successfully.|<<Event>>
|400|Bad Request/Invalid Parameters.|<<ApiError>>
|500|Internal server error.|<<ApiError>>
...
| POST | /triggers | link:#++POST__triggers++[Create a new trigger.]
...
| PUT | /triggers/groups/members/{memberId}/orphan | link:#++PUT__triggers_groups_members__memberId__orphan++[Make a non-orphan member trigger into an orphan.]
| PUT | /triggers/groups/members/{memberId}/unorphan | link:#++PUT__triggers_groups_members__memberId__unorphan++[Make an orphan member trigger into an group trigger.]
...
| DELETE | /triggers/groups/{groupId} | link:#++DELETE__triggers_groups__groupId_++[Delete a group trigger.]
...
| DELETE | /triggers/groups/{groupId}/dampenings/{dampeningId} | link:#++DELETE__triggers_groups__groupId__dampenings__dampeningId_++[Delete an existing group dampening definition.]
...
| PUT | /triggers/trigger/{triggerId} | link:#++PUT__triggers_trigger__triggerId_++[Update an existing full trigger (trigger, dampenings and conditions).]
| GET | /triggers/{triggerId} | link:#++GET__triggers__triggerId_++[Get an existing trigger definition.]
| DELETE | /triggers/{triggerId} | link:#++DELETE__triggers__triggerId_++[Delete an existing standard or group member trigger definition.]
| PUT | /triggers/{triggerId} | link:#++PUT__triggers__triggerId_++[Update an existing trigger definition.]
| GET | /triggers/{triggerId}/conditions | link:#++GET__triggers__triggerId__conditions++[Get all conditions for a specific trigger.]
...
| POST | /triggers/{triggerId}/dampenings | link:#++POST__triggers__triggerId__dampenings++[Create a new dampening.]
...
| GET | /triggers/{triggerId}/dampenings/{dampeningId} | link:#++GET__triggers__triggerId__dampenings__dampeningId_++[Get an existing dampening.]
...
| DELETE | /triggers/{triggerId}/dampenings/{dampeningId} | link:#++DELETE__triggers__triggerId__dampenings__dampeningId_++[Delete an existing dampening definition.]
|===
...
[[PUT__triggers_groups_members__memberId__orphan]]
...
[[PUT__triggers_groups_members__memberId__unorphan]]
...
|groupId|Yes|Group Trigger definition id to be deleted.|String|-
...
|groupId|Yes|The relevant Group definition id|String|-
...
|groupId|Yes|Group trigger definition id to be retrieved.|String|-
...
|200|Success, Dampening updated.|<<FullTrigger>>
|400|Bad Request/Invalid Parameters.|<<ApiError>>
|500|Internal server error.|<<ApiError>>
...
|groupId|Yes|Group Trigger definition id.|String|-
...
[[PUT__triggers_trigger__triggerId_]]
...
|200|Success, FullTrigger updated.|<<FullTrigger>>
|400|Bad Request/Invalid Parameters.|<<ApiError>>
|500|Internal server error.|<<ApiError>>
...
|200|Successfully fetched list of conditions.|List of <<Condition>>
|500|Internal server error.|<<ApiError>>
...
|200|Successfully fetched list of triggers.|<<Dampening>>
|404|Damppening not found|<<ApiError>>
|500|Internal server error.|<<ApiError>>
